...
if __name__ == '__main__':
    ...
    argparser.add_argument('--prompt_fp', type=str, default=r'F:\pythonProject\geval-main\prompts\summeval\fluency_rank.txt')
    argparser.add_argument('--save_fp', type=str, default=r'F:\pythonProject\geval-main\results\4o\40_flu_sy.json')
