...
if __name__ == '__main__':
    ...
    argparser.add_argument('--prompt_fp', type=str, default=r'F:\pythonProject\geval-main\prompts\summeval\fine_rank.txt')
    argparser.add_argument('--save_fp', type=str, default=r'F:\pythonProject\geval-main\results\4o\40_fin_sy.json')
